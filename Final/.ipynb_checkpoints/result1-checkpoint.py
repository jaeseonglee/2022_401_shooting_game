...
option_img = pygame.image.load('option.png') #종료버튼
...
background = pygame.image.load('background.jpeg') # 게임배경
background22 = pygame.image.load('background22.jpeg') # 게임배경
background33 = pygame.image.load('background33.png') # 게임배경
...
def nar1():
    ...
    message2 = myfont.render("Spacebar",True,(255,255,255))
